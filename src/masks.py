...
def get_mask_card_number(card_number: int) -> str:
    """ Маскирует номер  карты формата ХХХХ ХХ** **** ХХХХ, оставляя видимым первые шесть и последние четыре цыфры. """
...
def get_mask_account(account_number: Union[int, str]) -> str:
    """ Маскирует банковский счет формата **ХХХХ, отображая лишь последние четыре цыфры счета. """
